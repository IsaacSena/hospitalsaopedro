        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse d-flex justify-content-center" id="navbarNav">
                ...
                <form class="d-flex justify-content-center" role="search">
                    <button class="btn btn-outline-primary mx-2" type="button" onclick="window.location.href='/cadastrarPaciente'">Paciente</button>
                    <button class="btn btn-outline-primary mx-2" type="button" onclick="window.location.href='/loginFuncionarios'">Funcionarios</button>
        ...
        <div class="row my-4">
            ...
            <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="mb-2">
                        <a href="#!" class="text-white"><i class="fas fa-paw pe-3"></i>Registrar-se</a>
                    </li>
                    <li class="mb-2">
                        <a href="#!" class="text-white"><i class="fas fa-paw pe-3"></i>Consultas</a>
                    </li>
                </ul>
            </div>
