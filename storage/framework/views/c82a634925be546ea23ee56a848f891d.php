...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layout','data' => ['titulo' => 'sobreNos']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['titulo' => 'sobreNos']); ?>
    <!-- Navbar -->
    ...
    <main>
        ...
        <section style="display: flex; justify-content: center; gap: 20px; padding: 60px 0;">
            ...
            <img style="width:300px; height:auto;" src="<?php echo e(URL::to('/assets/img/emerson.jpeg')); ?>">
...
<?php endif; ?>
<?php /**PATH C:\hospital\laravel\resources\views/paginas/telaSobreNos.blade.php ENDPATH**/ ?>